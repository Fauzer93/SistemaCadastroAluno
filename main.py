...
def alunos():
    ...
    def novo_aluno():
        ...
        global imagem, imagem_string, l_imaagem
        ...
        # mostrando a mensagemde sucesso
    ...
    def update_aluno():
        ...
        try:
            ...
            # Inserindo os valores nos camposde entradas
    ...
    # Pegando as informações do banco turmas
    turmas = ver_turmas()
    turma = []
    ...
    l_linha =  Label(frame_detalhes, relief=GROOVE, text='h', width=1, height=140, anchor=NW, font=('Ivy 1'), bg=co0, fg=co0)
    l_linha.place(x=610, y=10)
    l_linha =  Label(frame_detalhes, relief=GROOVE, text='h', width=1, height=140, anchor=NW, font=('Ivy 1'), bg=co1, fg=co0)
    ...
    botao_ver =  Button(frame_detalhes, anchor=CENTER, text='Ver'.upper(), width=10, overrelief=RIDGE, font=('Ivy 7 bold'), bg=co1, fg=co0)
...
# função para adicionar crusos e Turmas
def adicionar():
    ...
    def novo_curso():
        ...
        # Verificando se os valores etsão vazio
        for i in lista:
            if i=="":
                messagebox.showerror('Erro', 'Preencha todos os campos')
        ...
        # mostrando mensagem de sucesso
        messagebox.showerror('Sucesso', 'os dados forma inseridos com sucesso')
    ...
    def delete_curso():
        try:
            ...
            # mmostrando os valores na tabela
            mostrar_cursos()
    ...
    l_duracao = Label(frame_detalhes, text="Duracão *", height=1, anchor=NW, font=('Ivy 10'), bg=co1, fg=co4)
    ...
    # Peganado as informações do banco Cursos
    cursos = ver_cursos()
    curso = []
    ...
    l_data_inicio = Label(frame_detalhes, text="Data inicio *", height=1, anchor=NW, font=('Ivy 10'), bg=co1, fg=co4)
